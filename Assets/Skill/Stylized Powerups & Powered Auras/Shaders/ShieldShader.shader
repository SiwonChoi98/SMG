...
Shader "Stylized Powerups/Shield Shader"
{
	Properties
	{
		...
		[ASEBegin]_Brightness("Brightness", Float) = 1
		...
		[ASEEnd]_PanningSpeed("Panning Speed", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float fresnelNdotV71 = dot( ase_worldNormal, V );
				...
				surfaceDescription.Color = ( temp_output_64_0 + ( ( fresnelNode48 * ParticleColor14 ) * ( _FresnelColor * _FresnelColorBrightness ) ) ).xyz;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( tex2D( _Mask, uv_Mask ).r * clampResult78 ).x;
...
/*ASEBEGIN
Version=18707
-1920;0;1920;1029;3105.719;1519.923;2.838926;True;False
...
Node;AmplifyShaderEditor.Vector2Node;67;-1392.796,-233.184;Inherit;False;Property;_PanningSpeed;Panning Speed;6;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-826.7871,-426.3606;Inherit;False;Property;_Brightness;Brightness;0;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;25;-941.6357,-342.7973;Inherit;True;Property;_MainTex1;Main Texture;1;0;Create;False;0;0;False;0;False;-1;d570e72a4dbde124ca4865c0ca828532;de5ce1a6254c83b4db17e88ce430bee5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;79;-365.2471,460.6813;Inherit;True;Property;_Mask;Mask;2;0;Create;True;0;0;False;0;False;-1;d570e72a4dbde124ca4865c0ca828532;de5ce1a6254c83b4db17e88ce430bee5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;80;-40.10791,418.9618;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ColorNode;51;-1023.83,-1186.632;Inherit;False;Property;_FresnelColor;Fresnel Color;4;0;Create;True;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;49;-1336.626,-816.0569;Inherit;False;Property;_FresnelPower;Fresnel Power;3;0;Create;True;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-1055.454,-1023.171;Inherit;False;Property;_FresnelColorBrightness;Fresnel Color Brightness;5;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=EA9ABE22A006181321B8D4F99390015461C2C6E1