...
Shader "Stylized Powerups/Unlit Fresnel Vertex Color Blend"
{
	Properties
	{
		...
		[ASEEnd]_MainTexTiling("Main Tex Tiling", Vector) = (1,1,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 appendResult11 = (float4(packedInput.ase_color.r , packedInput.ase_color.g , packedInput.ase_color.b , 0.0));
				float4 ParticleColor14 = appendResult11;
				float2 texCoord36 = packedInput.ase_texcoord1.xy * _MainTexTiling + float2( 0,0 );
				...
				float fresnelNdotV48 = dot( ase_worldNormal, V );
				...
				float4 temp_cast_9 = (tex2DNode25.r).xxxx;
				float4 temp_cast_10 = (tex2DNode25.g).xxxx;
				float4 temp_cast_11 = (tex2DNode25.b).xxxx;
				float4 temp_cast_12 = (tex2DNode25.a).xxxx;
				float2 texCoord41 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner42 = ( 1.0 * _Time.y * _MaskPanning + texCoord41);
				float4 tex2DNode43 = tex2D( _Mask, panner42 );
				float4 temp_cast_13 = (tex2DNode43.a).xxxx;
				float4 temp_cast_14 = (tex2DNode43.r).xxxx;
				float4 temp_cast_15 = (tex2DNode43.g).xxxx;
				float4 temp_cast_16 = (tex2DNode43.b).xxxx;
				float4 temp_cast_17 = (tex2DNode43.a).xxxx;
				#if defined(_MASKTEXTURELAYER_RGBA)
				float4 staticSwitch44 = tex2DNode43;
				#elif defined(_MASKTEXTURELAYER_RED)
				float4 staticSwitch44 = temp_cast_14;
				#elif defined(_MASKTEXTURELAYER_GREEN)
				float4 staticSwitch44 = temp_cast_15;
				#elif defined(_MASKTEXTURELAYER_BLUE)
				float4 staticSwitch44 = temp_cast_16;
				...
				float4 staticSwitch27 = temp_cast_9;
				#elif defined(_ALPHALAYER_GREEN)
				float4 staticSwitch27 = temp_cast_10;
				#elif defined(_ALPHALAYER_BLUE)
				float4 staticSwitch27 = temp_cast_11;
				...
				float ParticleAlpha16 = packedInput.ase_color.a;
				
				surfaceDescription.Color = ( ( ( ParticleColor14 * Main24 ) * _Brightness ) + ( saturate( 	max( blendOpSrc56, blendOpDest56 ) )) ).xyz;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( Alpha28 * ParticleAlpha16 ).r;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord36 = packedInput.ase_texcoord.xy * _MainTexTiling + float2( 0,0 );
				float2 panner37 = ( 1.0 * _Time.y * _MainTexturePanning + texCoord36);
				float4 tex2DNode25 = tex2D( _MainTex1, panner37 );
				...
				float2 texCoord41 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner42 = ( 1.0 * _Time.y * _MaskPanning + texCoord41);
				float4 tex2DNode43 = tex2D( _Mask, panner42 );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord36 = packedInput.ase_texcoord3.xy * _MainTexTiling + float2( 0,0 );
				float2 panner37 = ( 1.0 * _Time.y * _MainTexturePanning + texCoord36);
				float4 tex2DNode25 = tex2D( _MainTex1, panner37 );
				float4 temp_cast_0 = (tex2DNode25.a).xxxx;
				float4 temp_cast_1 = (tex2DNode25.r).xxxx;
				...
				float4 temp_cast_3 = (tex2DNode25.b).xxxx;
				float4 temp_cast_4 = (tex2DNode25.a).xxxx;
				float2 texCoord41 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner42 = ( 1.0 * _Time.y * _MaskPanning + texCoord41);
				float4 tex2DNode43 = tex2D( _Mask, panner42 );
				float4 temp_cast_5 = (tex2DNode43.a).xxxx;
				float4 temp_cast_6 = (tex2DNode43.r).xxxx;
...
/*ASEBEGIN
Version=18707
-1920;0;1920;1029;1744.951;1322.392;1;True;False
...
Node;AmplifyShaderEditor.Vector2Node;40;-1481.597,-496.5421;Inherit;False;Property;_MaskPanning;Mask Panning;8;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;43;-1074.704,-491.0439;Inherit;True;Property;_Mask;Mask;6;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;57;-670.9514,-1014.392;Inherit;False;Property;_MainTexTiling;Main Tex Tiling;12;0;Create;True;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.StaticSwitch;44;-783.2813,-482.2463;Inherit;False;Property;_MaskTextureLayer;Mask Texture Layer;7;0;Create;True;0;0;False;0;False;0;4;4;True;;KeywordEnum;5;RGBA;Red;Green;Blue;Alpha;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;46;-543.5445,-477.848;Inherit;False;Property;_UseMask;Use Mask?;5;0;Create;True;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.Vector2Node;38;-399.3413,-883.797;Inherit;False;Property;_MainTexturePanning;Main Texture Panning;3;0;Create;True;0;0;False;0;False;0,0;1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.StaticSwitch;20;476.1555,-899.6291;Inherit;False;Property;_MainTextureLayer;Main Texture Layer;1;0;Create;True;0;0;False;0;False;0;0;0;True;;KeywordEnum;5;RGBA;Red;Green;Blue;Alpha;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-584.2401,-274.2615;Inherit;False;Property;_FresnelPower;Fresnel Power;9;0;Create;True;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-657.9203,41.68527;Inherit;False;Property;_FresnelColorBrightness;Fresnel Color Brightness;11;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;141.2774,-114.0063;Inherit;False;Property;_Brightness;Brightness;4;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;51;-626.2964,-121.7756;Inherit;False;Property;_FresnelColor;Fresnel Color;10;0;Create;True;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;55;126.222,-10.84846;Inherit;False;14;ParticleColor;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;7;0,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DistortionVectors;0;6;DistortionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;True;True;0;True;-11;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;0,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;ShadowCaster;0;1;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;6;0,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;True;True;0;True;-9;255;False;-1;255;True;-10;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;3;0,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;META;0;2;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;4;0,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=SceneSelectionPass;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;1063.809,-52.02347;Float;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;13;Stylized Powerups/Unlit Fresnel Vertex Color Blend;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;5;0;True;1;0;True;-20;0;True;-21;1;0;True;-22;0;True;-23;False;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;True;True;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;True;-24;True;0;True;-32;False;True;1;LightMode=ForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;1;  Rendering Pass ;0;  Rendering Pass;1;  Blending Mode;2;  Receive Fog;1;  Distortion;0;    Distortion Mode;0;    Distortion Only;1;  Depth Write;1;  Cull Mode;0;  Depth Test;4;Double-Sided;0;Alpha Clipping;0;Motion Vectors;1;  Add Precomputed Velocity;0;Shadow Matte;0;Cast Shadows;1;DOTS Instancing;0;GPU Instancing;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;7;True;True;True;True;True;True;False;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;5;0,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DepthForwardOnly;0;4;DepthForwardOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;False;False;True;True;0;True;-7;255;False;-1;255;True;-8;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=DF77402741200C30F13FECBDABA3DD471B4D870A