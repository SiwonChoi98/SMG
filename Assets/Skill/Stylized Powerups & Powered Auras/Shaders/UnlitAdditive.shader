...
Shader "Stylized Powerups/Unlit Simple"
{
	Properties
	{
		...
		[ASEEnd]_MaskPanning("Mask Panning", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 uv_MainTex1 = packedInput.ase_texcoord1.xy * _MainTex1_ST.xy + _MainTex1_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_MainTex1 = packedInput.ase_texcoord.xy * _MainTex1_ST.xy + _MainTex1_ST.zw;
				float2 panner37 = ( 1.0 * _Time.y * _MainTexturePanning + uv_MainTex1);
				float4 tex2DNode25 = tex2D( _MainTex1, panner37 );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_MainTex1 = packedInput.ase_texcoord3.xy * _MainTex1_ST.xy + _MainTex1_ST.zw;
				float2 panner37 = ( 1.0 * _Time.y * _MainTexturePanning + uv_MainTex1);
				float4 tex2DNode25 = tex2D( _MainTex1, panner37 );
				float4 temp_cast_0 = (tex2DNode25.a).xxxx;
				float4 temp_cast_1 = (tex2DNode25.r).xxxx;
...
/*ASEBEGIN
Version=18707
2725;160;1920;1029;1420.189;1157.836;1;True;False
...
Node;AmplifyShaderEditor.StaticSwitch;44;-783.2813,-482.2463;Inherit;False;Property;_MaskTextureLayer;Mask Texture Layer;7;0;Create;True;0;0;False;0;False;0;4;3;True;;KeywordEnum;5;RGBA;Red;Green;Blue;Alpha;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector2Node;38;-516.7556,-947.0201;Inherit;False;Property;_MainTexturePanning;Main Texture Panning;3;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;13;141.2774,-114.0063;Inherit;False;Property;_Brightness;Brightness;4;0;Create;True;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;20;476.1555,-899.6291;Inherit;False;Property;_MainTextureLayer;Main Texture Layer;1;0;Create;True;0;0;False;0;False;0;0;4;True;;KeywordEnum;5;RGBA;Red;Green;Blue;Alpha;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=B4417032343051C600C3A575CF5E1E3D0E0037FA